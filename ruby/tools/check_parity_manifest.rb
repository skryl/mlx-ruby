...
DEFAULT_CONTRACT = File.expand_path("../parity/phase0_contract.json", __dir__)
...
parser = OptionParser.new do |opts|
  opts.banner = "Usage: ruby/tools/check_parity_manifest.rb --manifest PATH [--contract PATH]"
