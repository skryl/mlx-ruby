...
class Phase282GraphIrOnnxStubParityTest < Minitest::Test
  ...
  def test_ir_to_onnx_stub_maps_core_ops
    stub = TestSupport.parse_onnx_stub(exported_payload, opset: 18, model_name: "exp_add")
  ...
  def test_ir_to_onnx_stub_rejects_unknown_ops
