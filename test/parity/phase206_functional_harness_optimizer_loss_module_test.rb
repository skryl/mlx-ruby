...
class Phase206FunctionalHarnessOptimizerLossModuleTest < Minitest::Test
  def setup
    TestSupport.build_native_extension!
  end

  def test_harness_optimizer_loss_module_section
    tool = File.join(RUBY_ROOT, "tools", "parity", "generate_functional_golden_report.rb")
    ...
    section = payload.fetch("sections").fetch("optimizer_loss_module")
