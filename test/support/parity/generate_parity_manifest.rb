  ...
  def generate
    {
      "metadata" => {
        ...
        "repo_root" => @repo_root,
        "generator" => "ruby/test/support/parity/generate_parity_manifest.rb"
      },
...
parser = OptionParser.new do |opts|
  opts.banner = "Usage: ruby/test/support/parity/generate_parity_manifest.rb --repo-root PATH --output PATH"
