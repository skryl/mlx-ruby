...
You can also install the MLX Ruby package from source or just the C++
...
If you installed MLX with Ruby, then add the following to the CMake file:
...
.. code-block:: cmake
  ...
  find_package(
    ...
    REQUIRED)
  # Use the MLX gem installation path for MLX_ROOT in your local build.
  # You can inspect the installed gem files to discover the shipped C++ libraries.
